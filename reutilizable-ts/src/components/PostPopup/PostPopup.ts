        ...
        if (this.shadowRoot && this.post) {
            this.shadowRoot.innerHTML = `
                <div class="popup">
                    ...
                    <p><strong>Categoría:</strong> ${this.post.categorie}</p>
                    <p><strong>Ingredientes:</strong> ${this.post.ingredients}</p>
                    <p><strong>Preparación:</strong> ${this.post.preparation}</p>
                    <p><strong>Tiempo:</strong> ${this.post.time}</p>
